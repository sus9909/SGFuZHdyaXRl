...
ur = "/d.bin", fr = (() => {
    ...
    l.setAttribute("href", "data:image/svg+xml;base64," + window.btoa(a)), l.setAttribute("download", Z.toString().toLowerCase().replace(/\s+/g, "-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-").trim() + ".svg"), l.click()
});
